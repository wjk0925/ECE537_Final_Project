...
class TransformerEncoder(nn.Module):
    def __init__(self, src_vocab_size, embedding_dim, num_heads,
        num_layers, dim_feedforward, max_len_src, dropout_rate, embedding_factor):
        ...
        self.embedding.weight = torch.nn.Parameter(self.embedding.weight.data * embedding_factor)
...
class TransformerDecoder(nn.Module):
    def __init__(self, trg_vocab_size, embedding_dim, num_heads,
        num_layers, dim_feedforward, max_len_trg, dropout_rate, embedding_factor):
