...
#SBATCH --job-name=train_text2unit_hubert200_v2
#SBATCH --output="train_text2unit_hubert200_v2_%j.out"
#SBATCH --error="train_text2unit_hubert200_v2_%j.err"
